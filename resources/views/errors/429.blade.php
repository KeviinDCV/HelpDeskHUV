...
<head>
    ...
    <title>Demasiadas solicitudes - HelpDesk HUV</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .timer-bar {
            background: #e2e8f0; border-radius: 100px; height: 8px;
...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <p>Ha realizado demasiados intentos en poco tiempo. Por favor espere un momento antes de intentarlo de nuevo.</p>
            <div class="timer-bar">
                <div class="timer-fill"></div>
            </div>
            <p class="hint">La barra indica el tiempo aproximado de espera</p>
