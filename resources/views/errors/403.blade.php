...
<head>
    ...
    <title>Acceso denegado - HelpDesk HUV</title>
...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <p>No tiene permisos para acceder a esta página. Si cree que esto es un error, contacte al administrador del sistema.</p>
