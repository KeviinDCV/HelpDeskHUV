...
export default function CrearTelefono({ states, manufacturers, types, models, locations, entities }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post('/inventario/telefonos', formData, {
    ...
    return (
        <>
            <Head title="Crear Teléfono - HelpDesk HUV" />
            <div className="min-h-screen flex flex-col bg-gray-50">
                <GLPIHeader breadcrumb={
                    <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-gray-400">/</span>
                        <Link href="/inventario/telefonos" className="text-gray-600 hover:text-[#2c4370] hover:underline">Teléfonos</Link>
                        <span className="text-gray-400">/</span>
                    ...
                    <div className="max-w-5xl mx-auto">
                        <div className="bg-white rounded-lg shadow">
                            <div className="px-6 py-4 border-b">
                                <h1 className="text-xl font-semibold text-gray-900">Nuevo Teléfono</h1>
                                <p className="text-sm text-gray-500 mt-1">Complete los campos para registrar un nuevo teléfono</p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="p-4">
                                <div className="mb-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        <div className="md:col-span-2">
                                            ...
                                            <Input id="name" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} placeholder="Ej: TEL-RECEPCION-001" required aria-invalid={!!errors.name} aria-describedby={errors.name ? 'name-error' : undefined} className="mt-1 h-8 text-sm" />
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        ...
                                        <div>
                                            <Label htmlFor="phonetypes_id" className="text-xs">Tipo</Label>
                                            <SelectWithCreate id="phonetypes_id" value={formData.phonetypes_id} onValueChange={(v) => setFormData({ ...formData, phonetypes_id: v })} options={types} dropdownType="phonetypes" createLabel="Nuevo tipo" className="mt-1" triggerClassName="h-8 text-xs" />
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            <Label htmlFor="phonemodels_id" className="text-xs">Modelo</Label>
                                            <SelectWithCreate id="phonemodels_id" value={formData.phonemodels_id} onValueChange={(v) => setFormData({ ...formData, phonemodels_id: v })} options={models} dropdownType="phonemodels" createLabel="Nuevo modelo" className="mt-1" triggerClassName="h-8 text-xs" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-end gap-3 pt-4 border-t">
                                    <Button type="button" variant="outline" size="sm" onClick={() => router.visit('/inventario/telefonos')}>Cancelar</Button>
