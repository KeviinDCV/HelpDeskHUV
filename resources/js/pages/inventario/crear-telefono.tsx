                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <Select value={formData.phonetypes_id} onValueChange={(v) => setFormData({ ...formData, phonetypes_id: v })}>
                                                <SelectTrigger id="phonetypes_id" className="mt-1 h-8 text-xs"><SelectValue placeholder="Seleccionar..." /></SelectTrigger>
                                        ...
                                        <div>
                                            ...
                                            <Select value={formData.phonemodels_id} onValueChange={(v) => setFormData({ ...formData, phonemodels_id: v })}>
                                                <SelectTrigger id="phonemodels_id" className="mt-1 h-8 text-xs"><SelectValue placeholder="Seleccionar..." /></SelectTrigger>
