                    ...
                    <div className="bg-white rounded-lg shadow">
                        ...
                        <div className="px-6 py-3 bg-gray-50 border-b flex items-center justify-between">
                            ...
                            <p className="text-sm text-gray-600">
                                Mostrando <span className="font-medium">{phones.data.length}</span> de{' '}
                                <span className="font-medium">{phones.total}</span> teléfonos
                            </p>
                        </div>
                        ...
                        <div className="px-6 py-4 border-t flex items-center justify-between">
                            <div className="text-sm text-gray-600">
                                Página <span className="font-medium">{phones.current_page}</span> de{' '}
                                <span className="font-medium">{phones.last_page}</span>
                            </div>
