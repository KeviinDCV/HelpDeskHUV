...
export default function CrearDispositivoRed({ states, manufacturers, types, models, locations, entities }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post('/inventario/dispositivos-red', formData, {
    ...
    return (
        <>
            <Head title="Crear Dispositivo de Red - HelpDesk HUV" />
            <div className="min-h-screen flex flex-col bg-gray-50">
                <GLPIHeader breadcrumb={
                    <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-gray-400">/</span>
                        <Link href="/inventario/dispositivos-red" className="text-gray-600 hover:text-[#2c4370] hover:underline">Dispositivos de Red</Link>
                        <span className="text-gray-400">/</span>
                    ...
                    <div className="max-w-5xl mx-auto">
                        <div className="bg-white rounded-lg shadow">
                            <div className="px-6 py-4 border-b">
                                <h1 className="text-xl font-semibold text-gray-900">Nuevo Dispositivo de Red</h1>
                                <p className="text-sm text-gray-500 mt-1">Complete los campos para registrar un nuevo equipo de red</p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="p-4">
                                <div className="mb-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        <div className="md:col-span-2">
                                            ...
                                            <Input id="name" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} placeholder="Ej: SWITCH-PISO3-001" required aria-invalid={!!errors.name} aria-describedby={errors.name ? 'name-error' : undefined} className="mt-1 h-8 text-sm" />
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        ...
                                        <div>
                                            <Label htmlFor="networkequipmenttypes_id" className="text-xs">Tipo</Label>
                                            <SelectWithCreate id="networkequipmenttypes_id" value={formData.networkequipmenttypes_id} onValueChange={(v) => setFormData({ ...formData, networkequipmenttypes_id: v })} options={types} dropdownType="networkequipmenttypes" createLabel="Nuevo tipo" className="mt-1" triggerClassName="h-8 text-xs" />
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            <Label htmlFor="networkequipmentmodels_id" className="text-xs">Modelo</Label>
                                            <SelectWithCreate id="networkequipmentmodels_id" value={formData.networkequipmentmodels_id} onValueChange={(v) => setFormData({ ...formData, networkequipmentmodels_id: v })} options={models} dropdownType="networkequipmentmodels" createLabel="Nuevo modelo" className="mt-1" triggerClassName="h-8 text-xs" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-end gap-3 pt-4 border-t">
                                    <Button type="button" variant="outline" size="sm" onClick={() => router.visit('/inventario/dispositivos-red')}>Cancelar</Button>
