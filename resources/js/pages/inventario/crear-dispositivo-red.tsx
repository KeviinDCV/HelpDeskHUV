                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <Select value={formData.networkequipmenttypes_id} onValueChange={(v) => setFormData({ ...formData, networkequipmenttypes_id: v })}>
                                                <SelectTrigger id="networkequipmenttypes_id" className="mt-1 h-8 text-xs"><SelectValue placeholder="Seleccionar..." /></SelectTrigger>
                                        ...
                                        <div>
                                            ...
                                            <Select value={formData.networkequipmentmodels_id} onValueChange={(v) => setFormData({ ...formData, networkequipmentmodels_id: v })}>
                                                <SelectTrigger id="networkequipmentmodels_id" className="mt-1 h-8 text-xs"><SelectValue placeholder="Seleccionar..." /></SelectTrigger>
