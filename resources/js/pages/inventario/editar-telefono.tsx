                            ...
                            <form onSubmit={handleSubmit} className="p-4">
                                ...
                                <div className="mb-4"><h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">Clasificación</h3>
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        ...
                                        <div><Label htmlFor="phonetypes_id" className="text-xs">Tipo</Label><SelectWithCreate id="phonetypes_id" value={formData.phonetypes_id} onValueChange={(v) => setFormData({ ...formData, phonetypes_id: v })} options={types} dropdownType="phonetypes" createLabel="Nuevo tipo" className="mt-1" triggerClassName="h-8 text-xs" /></div>
                                        ...
                                        <div><Label htmlFor="phonemodels_id" className="text-xs">Modelo</Label><SelectWithCreate id="phonemodels_id" value={formData.phonemodels_id} onValueChange={(v) => setFormData({ ...formData, phonemodels_id: v })} options={models} dropdownType="phonemodels" createLabel="Nuevo modelo" className="mt-1" triggerClassName="h-8 text-xs" /></div>
                                    </div>
                                </div>
