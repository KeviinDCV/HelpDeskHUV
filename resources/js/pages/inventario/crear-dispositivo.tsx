...
export default function CrearDispositivo({ states, manufacturers, types, models, locations, entities }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post('/inventario/dispositivos', formData, {
    ...
    return (
        <>
            <Head title="Crear Dispositivo - HelpDesk HUV" />
            <div className="min-h-screen flex flex-col bg-gray-50">
                <GLPIHeader breadcrumb={
                    <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-gray-400">/</span>
                        <Link href="/inventario/dispositivos" className="text-gray-600 hover:text-[#2c4370] hover:underline">Dispositivos</Link>
                        <span className="text-gray-400">/</span>
                    ...
                    <div className="max-w-5xl mx-auto">
                        <div className="bg-white rounded-lg shadow">
                            <div className="px-6 py-4 border-b">
                                <h1 className="text-xl font-semibold text-gray-900">Nuevo Dispositivo</h1>
                                <p className="text-sm text-gray-500 mt-1">Complete los campos para registrar un nuevo periférico</p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="p-4">
                                <div className="mb-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        <div className="md:col-span-2">
                                            ...
                                            <Input id="name" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} placeholder="Ej: TECLADO-USB-001" required aria-invalid={!!errors.name} aria-describedby={errors.name ? 'name-error' : undefined} className="mt-1 h-8 text-sm" />
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        ...
                                        <div>
                                            <Label htmlFor="peripheraltypes_id" className="text-xs">Tipo</Label>
                                            <SelectWithCreate id="peripheraltypes_id" value={formData.peripheraltypes_id} onValueChange={(v) => setFormData({ ...formData, peripheraltypes_id: v })} options={types} dropdownType="peripheraltypes" createLabel="Nuevo tipo" className="mt-1" triggerClassName="h-8 text-xs" />
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            <Label htmlFor="peripheralmodels_id" className="text-xs">Modelo</Label>
                                            <SelectWithCreate id="peripheralmodels_id" value={formData.peripheralmodels_id} onValueChange={(v) => setFormData({ ...formData, peripheralmodels_id: v })} options={models} dropdownType="peripheralmodels" createLabel="Nuevo modelo" className="mt-1" triggerClassName="h-8 text-xs" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <SelectWithCreate id="locations_id" value={formData.locations_id} onValueChange={(v) => setFormData({ ...formData, locations_id: v })} options={locations} dropdownType="locations" createLabel="Nueva localización" useCompletename placeholder="Seleccionar ubicación..." className="mt-1" triggerClassName="h-8 text-xs" />
                                        </div>
                                        <div>
                                ...
                                <div className="flex justify-end gap-3 pt-4 border-t">
                                    <Button type="button" variant="outline" size="sm" onClick={() => router.visit('/inventario/dispositivos')}>Cancelar</Button>
