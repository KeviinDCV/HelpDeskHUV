                            ...
                            <form onSubmit={handleSubmit} className="p-4">
                                ...
                                <div className="mb-4"><h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">Clasificación</h3>
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        ...
                                        <div><Label htmlFor="printertypes_id" className="text-xs">Tipo</Label><SelectWithCreate id="printertypes_id" value={formData.printertypes_id} onValueChange={(v) => setFormData({ ...formData, printertypes_id: v })} options={types} dropdownType="printertypes" createLabel="Nuevo tipo" className="mt-1" triggerClassName="h-8 text-xs" /></div>
                                        ...
                                        <div><Label htmlFor="printermodels_id" className="text-xs">Modelo</Label><SelectWithCreate id="printermodels_id" value={formData.printermodels_id} onValueChange={(v) => setFormData({ ...formData, printermodels_id: v })} options={models} dropdownType="printermodels" createLabel="Nuevo modelo" className="mt-1" triggerClassName="h-8 text-xs" /></div>
                                    </div>
                                </div>
                                <div className="mb-4"><h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">Ubicación y Responsables</h3>
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        <div><Label htmlFor="locations_id" className="text-xs">Ubicación</Label><SelectWithCreate id="locations_id" value={formData.locations_id} onValueChange={(v) => setFormData({ ...formData, locations_id: v })} options={locations} dropdownType="locations" useCompletename placeholder="Seleccionar ubicación..." createLabel="Nueva localización" className="mt-1" triggerClassName="h-8 text-xs" /></div>
