...
colors:
  ...
  text-muted: "#2C4370"
  text-light: "#9A9A9A"
  accent-light: "rgba(45, 62, 94, 0.08)"
  accent-medium: "rgba(45, 62, 94, 0.15)"
  border: "rgba(45, 62, 94, 0.2)"
  card-bg: "rgba(45, 62, 94, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
- **Fonts** — already set to **Instrument Sans** (display) / **Helvetica Neue** (body); ignore any preset font name lingering in prose.
...
```html
<style>
@font-face{font-family:"Instrument Sans";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/InstrumentSans-Regular.woff") format("woff");}
@font-face{font-family:"Instrument Sans";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/InstrumentSans-Regular.woff2") format("woff2");}
</style>
```
